 ...
 *
 * - Если флаг @ref VI_CHAR_UNSIGNED определён, то @ref vi_wchar_t является синонимом
 ...
 * знаковым, либо беззнаковым в зависимости от флага компиляции @ref VI_CHAR_UNSIGNED.
 *
 * - Если флаг @ref VI_CHAR_UNSIGNED не определён, то @ref vi_wchar_t является синонимом
